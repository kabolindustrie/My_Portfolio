...
export default function Hero() {
  return (
    <div className="relative px-8 text-center text-main pt-44">

        <div className="relative w-full group max-w-sm min-w-0 mx-auto mt-[75px] mb-[75px] break-words bg-white border shadow-2xl rounded-xl">
          <div className="pb-6">
            ...
            <div className="mt-20 text-center">
              <h3 className=" text-2xl font-bold leading-normal text-gray-700 ">
                Kabol Amine
              </h3>
              <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                <div className="text-xl font-bold tracking-wide text-gray-600 font-mono mb-6">
                   Front-end Developer
                </div>
              </div>
              <div className="flex flex-wrap justify-center">
                <div className="w-full px-6">
                    ...
                    Découvrez mon travail dans le développement web. Explorez mes projets, compétences et collaborations.<strong> Prêt à créer ensemble ?</strong>
                    </p>
                </div>
            </div>

              <div className=" mx-6 mt-10 text-center border-t border-gray-200"></div>
              <div className="w-full text-center">
                <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                  <div className="flex space-x-2">
                    ...
                    <a
                      className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                      href="https://linkedin.com/in/amine-kabol-b2a92b24a"
                      rel="noopener"
      ...
      <p className="mb-8 sm:text-lg md:text-3xl">
        ...
        {/* <a
          href="https://github.com/kabolindustrie"
          target=""
          className="group inline-flex px-2"
        >
          <img
            width={30}
            height={30}
      ...
      <h1 className="font-lora text-4xl mb-12 max-w-xs mx-auto font-light sm:text 5xl sm:mb-14 sm:max-w-md md:text-6xl md:max-w-xl">
        Développeur <italic>React</italic> en quête de projets.
      </h1>
      <a
